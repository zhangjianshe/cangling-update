(function (global) {
  ...
  class Editor {
    ...
    render() {
      ...
      this.drawServiceVolumes(ctx,c);this.drawServicePorts(ctx,c);ctx.save();ctx.translate(0,5);this.drawServiceNetworks(ctx,c);ctx.restore();this.drawPanelChrome(ctx,"volume",c);this.drawPanelChrome(ctx,"port",c);this.drawPanelChrome(ctx,"network",c);
    }
    drawMounts(ctx,c) {
