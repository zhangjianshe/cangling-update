(function (global) {
  ...
  class Editor {
    constructor(options) {
      Object.assign(this, { selected: "", selectedVolume: "", selectedNetwork: "", selectedLink: null, volumePanelService: "", portPanelService: "", networkPanelService: "", hoverLink: null, hoverServiceVolumeRow: null, hoverServicePortRow: null, hoverServiceNetworkRow: null, linkFrom: "", linkTarget: "", drag: null, pointer: { x: 0, y: 0 }, panX: 0, panY: 0, zoom: 1 }, options);
    ...
    render() {
      ...
      ctx.fillStyle=c.bg;ctx.fillRect(0,0,width,height);this.drawGrid(ctx,width,height,c);ctx.translate(this.panX,this.panY);ctx.scale(this.zoom,this.zoom);this.drawSectionHeader(ctx,"服务","service",c.accent);this.drawSectionHeader(ctx,"命名卷","volume",c.volume);this.drawSectionHeader(ctx,"网络","network",c.network);
